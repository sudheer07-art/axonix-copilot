...
// ======================================================
// AXONIX AI Job Search Copilot
// index.js - Part 1
// Configuration + Navbar + Sidebar
// ======================================================

console.clear();
console.log("🚀 AXONIX Loaded");
...
function resetDashboard() {
    ...
    atsScore && (atsScore.textContent = "0%");
    skillsCount && (skillsCount.textContent = "0");
    jobCount && (jobCount.textContent = "0");
...
async function loadDashboard() {
    ...
    showPopup("🤖 AXONIX AI is analyzing your resume...");
    ...
    try {
        ...
        if (summary) {
            ...
            summary.innerHTML =
                "⚠ Unable to connect to AXONIX server.";
